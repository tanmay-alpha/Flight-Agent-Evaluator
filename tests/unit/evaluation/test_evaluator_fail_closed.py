...
def test_adversarial_do_nothing_agent_must_fail_approval_granted() -> None:
    ...
    scenario_path = Path("resources/scenarios/transactional/approval-granted.json")
    loaded = loader.load_from_path(scenario_path)
    expectation_path = Path("resources/expectations/transactional/approval-granted.json")
