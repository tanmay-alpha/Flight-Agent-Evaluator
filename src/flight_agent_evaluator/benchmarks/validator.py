...
class BenchmarkCorpusValidator:
    ...
    def build_authoritative_manifest(
        ...
        scenario_configs = [
            ...
            # 12 Transactional scenarios
            (
                "approval-granted",
                "resources/scenarios/transactional/approval-granted.json",
                "resources/expectations/transactional/approval-granted.json",
                "transactional",
                "hard",
                ("transactional", "transaction", "approval"),
            ),
            (
                "approval-denied",
                "resources/scenarios/transactional/approval-denied.json",
                "resources/expectations/transactional/approval-denied.json",
                "transactional",
                "hard",
                ("transactional", "transaction", "approval-denied"),
            ),
            (
                "approval-expires",
                "resources/scenarios/transactional/approval-expires.json",
                "resources/expectations/transactional/approval-expires.json",
                "transactional",
                "hard",
                ("transactional", "transaction", "approval-expires"),
            ),
            (
                "mutation-without-approval",
                "resources/scenarios/transactional/mutation-without-approval.json",
                "resources/expectations/transactional/mutation-without-approval.json",
                "transactional",
                "hard",
                ("transactional", "transaction", "safety"),
            ),
            (
                "payload-changes-after-approval",
                "resources/scenarios/transactional/payload-changes-after-approval.json",
                "resources/expectations/transactional/payload-changes-after-approval.json",
                "transactional",
                "hard",
                ("transactional", "transaction", "payload-hash"),
            ),
            (
                "idempotent-retry-after-timeout",
                "resources/scenarios/transactional/idempotent-retry-after-timeout.json",
                "resources/expectations/transactional/idempotent-retry-after-timeout.json",
                "transactional",
                "hard",
                ("transactional", "transaction", "idempotency"),
            ),
            (
                "duplicate-rebooking-attempt",
                "resources/scenarios/transactional/duplicate-rebooking-attempt.json",
                "resources/expectations/transactional/duplicate-rebooking-attempt.json",
                "transactional",
                "hard",
                ("transactional", "transaction", "duplicate-rebooking"),
            ),
            (
                "hold-expires",
                "resources/scenarios/transactional/hold-expires.json",
                "resources/expectations/transactional/hold-expires.json",
                "transactional",
                "hard",
                ("transactional", "transaction", "hold-expires"),
            ),
            (
                "mutation-success-response-lost",
                "resources/scenarios/transactional/mutation-success-response-lost.json",
                "resources/expectations/transactional/mutation-success-response-lost.json",
                "transactional",
                "hard",
                ("transactional", "transaction", "ambiguous-commit"),
            ),
            (
                "alternative-disappears-before-confirm",
                "resources/scenarios/transactional/alternative-disappears-before-confirm.json",
                "resources/expectations/transactional/alternative-disappears-before-confirm.json",
                "transactional",
                "hard",
                ("transactional", "transaction", "inventory-loss"),
            ),
            (
                "approval-wrong-itinerary",
                "resources/scenarios/transactional/approval-wrong-itinerary.json",
                "resources/expectations/transactional/approval-wrong-itinerary.json",
                "transactional",
                "hard",
                ("transactional", "transaction", "scope-mismatch"),
            ),
            (
                "constraint-changes-after-approval",
                "resources/scenarios/transactional/constraint-changes-after-approval.json",
                "resources/expectations/transactional/constraint-changes-after-approval.json",
                "transactional",
                "hard",
                ("transactional", "transaction", "stale-approval"),
            ),
        ]
